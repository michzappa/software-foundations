...
(* slower than a short-circuiting implementation, but it was not given as `Fixpoint` *)
...
(* There are zero elements of type baz since all of baz's constructors
require a baz to already exist. *)
